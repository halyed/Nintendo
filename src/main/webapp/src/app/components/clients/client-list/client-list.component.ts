...
export class ClientListComponent implements OnInit {
  ...
  private load(): void { this.clientService.getAll().subscribe({ next: (d) => { this.dataSource.data = d; this.dataSource.paginator = this.paginator; this.dataSource.sort = this.sort; this.loading = false; }, error: () => { this.loading = false; } }); }
